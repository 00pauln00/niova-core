...
typedef void     raft_net_prep_peer_state_cb_ctx_t;
...
// cleanup the cowr subapp tree on getting elected as leader and set leader
// data specific to application.
typedef raft_net_leader_prep_cb_ctx_t
(*raft_leader_prep_cb_t)(void);

//Prepare the peer with application specific data at bootup and shutdown.
typedef raft_net_prep_peer_state_cb_ctx_t
(*raft_prep_peer_state_cb_t)(int bootup);
