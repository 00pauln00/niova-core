...
static inline void
pmdb_direct_msg_init(struct pmdb_msg *msg, pmdb_obj_id_t *obj,
                     uint32_t data_size, uint8_t op, int64_t sequence_num)
{
    ...
    pmdb_obj_id_2_rncui(obj, &rncui);
    raft_net_client_user_id_copy(&msg->pmdbrm_user_id, &rncui);
