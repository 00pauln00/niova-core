...
func goRead(app_id *C.struct_raft_net_client_user_id, request_buf unsafe.Pointer,
	...
	return gcb.PmdbAPI.Read(unsafe.Pointer(app_id), request_buf,
		request_bufsz_go, reply_buf, reply_bufsz_go)
}
...
// Write a key-value pair into pumice DB
