...
def get_job_logs(job_id):
    url = "https://api.github.com/repos/00pauln00/niova-core/actions/jobs/{}/logs".format(job_id)
...
def parse_ansible_logs(job_id):
    ...
    # "PLAY RECAP.*?recipe_name: *\W*\w*.yml#*"gs
    play_recap_text = re.findall(r"PLAY RECAP.*?recipe_name: *\W*\w*.*?\w.yml", str(logs), flags= re.DOTALL)
