...
ansible-playbook -e 'srv_port=4000' -e npeers=$NPEERS -e dir_path=$LOG_PATH -e 'client_port=14000' -e 'recipe=leader_overthrow.yml' -e 'backend_type=pumicedb' $NIOVA_BIN_PATH/holon/ansible/holon.yml
